const PACKING_PLAN_HE = {
  ...
  people: [
    { id: "dad", label: "דני", emoji: "👨", essentials: ["דרכון / ת.ז. + רישיון נהיגה", "מתאם EU C/F", "מעיל גשם קל + שכבה חמה", "2–3 חולצות, מכנסי הליכה, תחתונים, פיג'מה", "נעלי הליכה נוחות ועמידות במים", "מוצרי טיפוח ותרופות", "טלפון, סוללה ניידת, ארנק"] },
    { id: "mum", label: "הילה", emoji: "👩", essentials: ["דרכון / ת.ז.", "מתאם EU C/F", "מעיל גשם קל + שכבה חמה", "2–3 חולצות, מכנסיים/חצאית, תחתונים, פיג'מה", "נעלי הליכה נוחות", "מוצרי טיפוח ותרופות", "טלפון, סוללה ניידת, תיק צד לימי עיר"] },
    { id: "teen", label: "יונתן", emoji: "🧑", essentials: ["דרכון / ת.ז.", "מעיל גשם + קפוצ'ון", "3 חולצות, מכנסיים/מכנסיים קצרים, תחתונים", "נעלי ספורט", "טלפון, מטען, אוזניות", "תרמיל קטן", "משקפי שמש וכובע"] },
    { id: "boy12", label: "זיו", emoji: "👦", essentials: ["דרכון / ת.ז.", "מעיל גשם + קפוצ'ון", "3 חולצות, מכנסיים, תחתונים", "נעלי ספורט", "תרמיל קטן", "כובע, משקפי שמש, בקבוק מים", "תרופות לבחילה (ימי שייט)"] },
    { id: "boy10", label: "רום", emoji: "👦", essentials: ["דרכון / ת.ז.", "מעיל גשם + קפוצ'ון", "3 חולצות, מכנסיים, תחתונים", "נעלי ספורט", "תרמיל קטן", "כובע, משקפי שמש, בקבוק מים", "תרופות לבחילה", "חטיפים לנסיעות ארוכות"] },
  ],
  daily: {
