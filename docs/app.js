  ...
  return {
    ...
    init() {
      try {
        ...
        const lang = localStorage.getItem("canal-compass-lang");
        if (lang === "he" || lang === "en") this.setLang(lang, false);
      } catch { /* defaults */ }
